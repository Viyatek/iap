...
public protocol RestoreHandlerDelegate {
...
public final class SubscriptionManager: NSObject {
    ...
    public var purchaseDelegate: PurchaseHandlerDelegate?
    public var restoreDelegate: RestoreHandlerDelegate?
    ...
    // MARK: - Configuration
    public func configure(sharedSecret: String, storeURL: URL?, endPoint: String?) {
    ...
    // MARK: - Fetch Products
    public func fetchAvailableProducts(with productIdentifiers: [String]) {
    ...
    public func checkSubscriptionStatus(completion: @escaping (Result<(isSubscribed: Bool, subExpiryDate: Date?), Error>) -> Void) {
...
extension SubscriptionManager {
    public func formattedPrice(for product: SKProduct) -> String {
    ...
    public func subscriptionType(for product: SKProduct) -> String {
    ...
    public func calculateDailyPrice(for product: SKProduct) -> String {
    ...
    public func getFreeTrialDaysNumber(product: SKProduct) -> Int {
